...
for meas in behav:
    print("\n\nAll Students:\n")
    print(
        "Global Efficiency Physics, {0}: {1}".format(
            meas, spearmanr(df["Global Efficiency Physics"], df[meas])
        )
    )
    print(
        "Global Efficiency General, {0}: {1}".format(
            meas, spearmanr(df["Global Efficiency General"], df[meas])
        )
    )
    print("\nMale Students:\n")
    print(
        "Global Efficiency Physics, {0}: {1}".format(
            meas, spearmanr(m_df["Global Efficiency Physics"], m_df[meas])
        )
    )
    print(
        "Global Efficiency General, {0}: {1}".format(
            meas, spearmanr(m_df["Global Efficiency General"], m_df[meas])
        )
    )
    print("\nFemale Students:\n")
    print(
        "Global Efficiency Physics, {0}: {1}".format(
            meas, spearmanr(f_df["Global Efficiency Physics"], f_df[meas])
        )
    )
    print(
        "Global Efficiency General, {0}: {1}".format(
            meas, spearmanr(f_df["Global Efficiency General"], f_df[meas])
        )
    )
