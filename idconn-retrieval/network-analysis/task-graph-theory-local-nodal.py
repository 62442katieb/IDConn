        ...
        for task in tasks.keys():
            for i in np.arange(0, len(tasks[task][0]['conditions'])):
                ...
                for mask in masks:
                    ...
                    df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal.csv'), sep=',')

df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal{0}.csv'.format(today)), sep=',')
