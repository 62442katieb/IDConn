...
subjects = ['101', '102', '103', '104', '106', '107', '108', '110', '212', '213',
            ...
            '634']
subjects = ['459', '460', '462', '463', '464', '465', '467']
kappa_upper = 0.21
kappa_lower = 0.31
    ...
    for session in sessions:
        ...
        for task in tasks.keys():
            for i in np.arange(0, len(tasks[task][0]['conditions'])):
                ...
                df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal_6.csv'), sep=',')

df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal_6_{0}.csv'.format(today)), sep=',')
