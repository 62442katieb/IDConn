...
subjects = ['101', '102', '103', '104', '106', '107', '108', '110', '212', '213',
            ...
            '634']
subjects = ['217', '218', '219', '320', '321', '322', '323', '324', '325', '327']
kappa_upper = 0.21
kappa_lower = 0.31
    ...
    for session in sessions:
        ...
        for task in tasks.keys():
            for i in np.arange(0, len(tasks[task][0]['conditions'])):
                ...
                df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal_2.csv'), sep=',')

df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal_2_{0}.csv'.format(today)), sep=',')
