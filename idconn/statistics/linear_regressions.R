...
dat <- read.csv('/Users/kbottenh/Dropbox/Projects/physics-retrieval/data/rescored/physics_learning-nonbrain_OLS-BayesianImpute.csv', header=TRUE)
...
outcomes <- c('FCIPhyAcc2', 'RetrPhyAcc2', 'Phy48Grade')
...
for (iq in iqs) {
    for (outcome in outcomes) {
        ...
        write.csv(df, '/Users/kbottenh/Dropbox/Projects/physics-retrieval/data/output/performance~iq-ols_robust-knn_imp-interaction-R.csv')
        ...
        write.csv(df.simple, '/Users/kbottenh/Dropbox/Projects/physics-retrieval/data/output/performance~iq-ols_robust-knn_imp-simple-R.csv')
