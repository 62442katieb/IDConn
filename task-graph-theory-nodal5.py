...
subjects = ['101', '102', '103', '104', '106', '107', '108', '110', '212', '213',
            ...
            '634']
subjects = ['348', '349', '350', '451', '452', '453', '455', '456', '457', '458']
kappa_upper = 0.21
kappa_lower = 0.31
    ...
    for session in sessions:
        ...
        for task in tasks.keys():
            for i in np.arange(0, len(tasks[task][0]['conditions'])):
                ...
                df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal_5.csv'), sep=',')

df.to_csv(join(sink_dir, 'physics-learning-tasks_graphtheory_shen+craddock_nodal_5_{0}.csv'.format(today)), sep=',')
