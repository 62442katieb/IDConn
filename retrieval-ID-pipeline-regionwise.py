...
for subject in subjects:
    ...
    for run in runs:
        ...
        icn_regions = regions.connected_label_regions(icn, min_size=50., labels=labels)
    ...
    for condition in conditions:
        ...
        np.savetxt(join(sink_dir, '{0}-{1}-regionwise-corrmat.csv'.format(subject, condition)), corrmats[condition])
